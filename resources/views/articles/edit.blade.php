        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col mt-3">
                    ...
                    <form class="my-4 bg-white border border-warning rounded shadow p-3" action="{{ route('updateArticle', $article) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="d-flex justify-content-between">                        
                            <h1 class="text-warning mb-4">Modifica articolo</h1>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="categories[]" value="{{ $category->id }}" @checked($article->categories->contains($category->id))
                                >
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="body" class="form-control" id="body" rows="10" value="{{ old('body', $article->body) }}">{{ $article->body }}</textarea>
                            @error('body') <span class="small text-danger">{{ $message }}</span> @enderror
                        </div>
                        <div class="text-end">
                        <button type="submit" class="btn btn-warning my-3">Modifica articolo</button>
                        </div>
                    </form>
